...
[Ozone](https://github.com/dplyukhin/ozone) is an experimental library that lets you safely use *futures* in your Choral code. With Ozone, you can write endpoint code that handles requests in parallel or returns values asynchronously (e.g. via a `CompletableFuture`). You can learn more about Ozone in the article **[Ozone: Fully Out-of-Order Choreographies](https://arxiv.org/pdf/2401.17403)**. 
</div>
<div class="col-4 col-md-4 col-lg-3 col-xl-2 mx-auto">
